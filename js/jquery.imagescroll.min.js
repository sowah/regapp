!function (t, i) {
    ...
    function n(t, e, n) {
        var r = t.charAt(0).toUpperCase() + t.slice(1), h = (t + " " + H.join(r + " ") + r).split(" ");
    ...
    var r, h, l = {
            ...
            parallax: !0,
            touch: !1
        }, a = "imageScroll", d = "plugin_" + a, c = function (t, i) {
            return function () {
                return t.apply(i, arguments)
            }
        }, g = {}, m = document.documentElement, f = "imageScrollModernizr", u = document.createElement(f), p = u.style,
        v = "Webkit Moz O ms", H = v.split(" "), w = v.toLowerCase().split(" "), b = {}, y = 0, x = "",
        $ = function (t, i, e, s) {
            var o, n, r, h, l = document.createElement("div"), a = document.body,
    ...
    return b.csstransforms = function () {
        ...
        var i = (new Date).getTime(), e = Math.max(0, 16 - (i - y)), s = window.setTimeout(function () {
            t(i + e)
        }, e);
        return y = i + e, s
        ...
        constructor: r, init: function () {
            ...
            this.$scrollingElement = t("<img/>", {src: this.image}).addClass(this.settings.imgClass), this.settings.touch === !0 ? this.$scrollingElement.css({maxWidth: "100%"}).prependTo(this.$imageHolder) : this.settings.parallax === !0 ? (this.$scrollerHolder = t("<div/>", {html: this.$imageHolder.html()}).css({
                top: 0,
                visibility: "hidden",
                position: "fixed",
                overflow: "hidden"
            ...
            var t, i, e, s, o, n, r, h, l, a = this.settings.windowObject.height(),
                d = this.settings.windowObject.width() - this.settings.container.offset().left, c = this.coverRatio * a;
            ...
            if (this.scrollingState.holderDistanceFromTop <= this.scrollingState.winHeight && this.scrollingState.holderDistanceFromTop >= -this.scrollingState.imgHolderHeight) {
                ...
                this.$scrollerHolder.css(this._getCSSObject({
                    ...
                    visibility: "visible"
                })), this.$scrollingElement.css(this._getCSSObject({transform: h, x: 0, y: e, visibility: "visible"}))
